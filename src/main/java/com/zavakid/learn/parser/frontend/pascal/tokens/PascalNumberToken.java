...
import static com.zavakid.learn.parser.frontend.pascal.PascalErrorCode.INVALID_NUMBER;
import static com.zavakid.learn.parser.frontend.pascal.PascalErrorCode.RANGE_INTEGER;
import static com.zavakid.learn.parser.frontend.pascal.PascalErrorCode.RANGE_REAL;
import static com.zavakid.learn.parser.frontend.pascal.PascalTokenType.ERROR;
import static com.zavakid.learn.parser.frontend.pascal.PascalTokenType.INTEGER;
import static com.zavakid.learn.parser.frontend.pascal.PascalTokenType.REAL;
...
public class PascalNumberToken extends PascalToken {
    ...
    private static final int MAX_EXPONEN = 31;
    ...
    private float computeFloatValue(String wholeDigits, String fractionDigits,
        ...
        if (Math.abs(exponentValue + wholeDigits.length()) > MAX_EXPONEN) {
            type = ERROR;
            value = RANGE_REAL;
            return 0.0f;
        }
