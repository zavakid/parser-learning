...
import static com.zavakid.learn.parser.frontend.pascal.PascalTokenType.STRING;

import java.io.BufferedReader;
import java.io.FileReader;

import com.zavakid.learn.parser.backend.Backend;
import com.zavakid.learn.parser.backend.BackendFactory;
import com.zavakid.learn.parser.frontend.FrontendFactory;
        ...
        public void messageReceived(Message message) {
            ...
            switch (type) {
                ...
                case TOKEN: {
                    ...
                    System.out.println(String.format(TOKEN_FORMAT, tokenType, line, position,
                            tokenText));
                    if (tokenValue != null) {
                        if (tokenType == STRING) {
                ...
                case PARSER_SUMMARY: {
                    ...
                    System.out.printf(PARSER_SUMMARY_FORMAT, statementCount, syntaxErrors,
                            elapsedTime);
                    break;
                }
            }
        ...
        public void messageReceived(Message message) {
            ...
            switch (type) {
                ...
                case INTERPRETER_SUMMARY: {
                    ...
                    System.out.printf(INTERPRETER_SUMMARY_FORMAT, executionCount, runtimeErrors,
                            elapsedTime);
                    break;
                }
